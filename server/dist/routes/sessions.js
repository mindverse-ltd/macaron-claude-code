import { deleteSession, duplicateSession, readSessionMessages, resolveSessionCwd, rewindSession, searchMessages, writeCompactedSession, } from '../lib/session-store.js';
...
export async function registerSessionRoutes(app) {
    ...
    app.get('/api/search/messages', async ({ query }) => {
