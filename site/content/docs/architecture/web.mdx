...
`web/src/main.tsx` does more than mount React — it stands up the whole GenUI runtime *before* the app renders, because model-authored TSX previews need those globals to exist.
